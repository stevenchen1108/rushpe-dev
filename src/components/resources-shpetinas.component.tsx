    ...
    return (
        <>
            <div className="flex flex-col bg-[#ffdbf8] text-black p-4 mx-auto">
                ...
                <div className="flex flex-col bg-white rounded-md text-black mb-8 mx-8">
                    <ul className="flex flex-col list-none text-left shadow-md">
                        ...
                        <div className="flex flex-row items-center justify-center px-8 py-6 mx-auto w-full">
                            ...
                            <div className="text-left text-lg px-3 mt-3 mb-3">
                                ...
                                <p className="mt-3">If you're seeking an appointment or have general questions, please contact RICAP:</p>
                        ...
                        <div className="flex flex-row items-center justify-center px-8 py-6 mx-auto w-full">
                            ...
                            <div className="text-left text-lg px-4 mt-3 mb-3">
                        ...
                        <div className="flex flex-row items-center justify-center px-8 py-6 mx-auto w-full">
                            ...
                            <div className="text-left text-lg px-4 mt-3 mb-3">
                                <p> <a className="underline text-blue-700 font-bold" href="https://law.rutgers.edu/information-for/get-legal-help/rutgers-immigrant-community-assistance-project">
                                    ...
                                    Their goal is for <strong>all women and girls to achieve the best possible health</strong>. <br/>
                                    Learn more about them and the programs they provide at their website, linked <a className="underline text-blue-700 font-bold" href="https://womenshealth.gov/about-us/what-we-do">here</a>.
                                </p>                                
                            </div>
