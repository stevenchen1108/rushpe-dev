...
export type AlumniCardProps = {
  ...
  company?: string;
  /** Accept StaticImageData or string (we pass StaticImageData from data.ts) */
  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-5 pt-1 sm:px-6 sm:pb-6">
        <h3 className="text-[1.45rem] sm:text-[1.6rem] font-black leading-tight tracking-tight text-slate-900">
          {name}
        </h3>
        ...
        <div className="mt-4">
          <span
            className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2
                       ...
                       group-hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900"
          >
            Read spotlight
            <svg
              className="h-4 w-4"
